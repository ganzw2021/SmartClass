...
const PointsBoard = defineAsyncComponent(() => import('./components/PointsBoard.vue'))
...
const AdminCoursesModule = defineAsyncComponent(() => import('./components/AdminCoursesModule.vue'))
const AdminHomeworkStatsModule = defineAsyncComponent(() => import('./components/AdminHomeworkStatsModule.vue'))
const AdminAttendanceStatsModule = defineAsyncComponent(() => import('./components/AdminAttendanceStatsModule.vue'))
...
const teacherNavItems = [
  ...
  { id: 'random', label: '幸运签', component: RandomPicker, icon: markRaw({ template: '<svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 9v10c0 2 10 2 10 0V9M7 9c0-2 10-2 10 0S7 11 7 9zm2-1L8 3m4 5V2m3 6 1-5" /></svg>' }) },
  ...
  { id: 'points', label: '积分榜', component: PointsBoard, icon: markRaw({ template: '<span class="text-xs font-black">分</span>' }) },
...
const adminNavItems = [
  ...
  { id: 'courses', label: '课程管理', component: AdminCoursesModule, icon: markRaw({ template: '<svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>' }) },
  ...
  { id: 'homework_stats', label: '作业统计', component: AdminHomeworkStatsModule, icon: markRaw({ template: '<svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>' }) },
  { id: 'attendance_stats', label: '考勤统计', component: AdminAttendanceStatsModule, icon: markRaw({ template: '<svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" /></svg>' }) },
]
